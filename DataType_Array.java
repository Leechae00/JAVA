...
public class DataType_Array {
	...
	public static void main(String[] args) {
		...
		String[] names = {"Kim", "Ali","Richardsin"};
		...
		int avg_proj =0;
		for (int i = 0; i<3; i++) {
			avg_mid += scores_mid[i];
			avg_proj +=scores_proj[i];
		}
		avg_mid /= 3;
		avg_proj /= 3;
		System.out.println("MidTerm avg score: " + avg_mid);
		System.out.println("ProJect avg score: " + avg_proj);
	}
